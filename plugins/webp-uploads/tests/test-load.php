...
class Test_WebP_Uploads_Load extends TestCase {
	...
	public function test_it_should_create_the_original_mime_type_as_well_with_all_the_available_sources_for_the_specified_mime(): void {
		...
		$attachment_id = self::factory()->attachment->create_upload_object( TESTS_PLUGIN_DIR . '/data/images/balloons.webp' );
	...
	public function test_it_should_not_create_the_sources_property_if_the_mime_is_not_specified_on_the_transforms_images(): void {
		...
		$attachment_id = self::factory()->attachment->create_upload_object(
			TESTS_PLUGIN_DIR . '/data/images/balloons.webp'
		);
	...
	public function provider_replace_images_with_different_extensions(): Generator {
		yield 'An image with a .jpg extension' => array( TESTS_PLUGIN_DIR . '/data/images/leaves.jpg' );
		yield 'An image with a .jpeg extension' => array( TESTS_PLUGIN_DIR . '/data/images/car.jpeg' );
	}
	...
	public function data_provider_not_supported_webp_images(): Generator {
		yield 'PNG image' => array( TESTS_PLUGIN_DIR . '/data/images/dice.png' );
		yield 'GIFT image' => array( TESTS_PLUGIN_DIR . '/data/images/earth.gif' );
	}
	...
	public function test_it_should_use_the_original_image_to_generate_all_the_image_sizes(): void {
		...
		$attachment_id = self::factory()->attachment->create_upload_object( TESTS_PLUGIN_DIR . '/data/images/paint.jpeg' );
		$metadata      = wp_get_attachment_metadata( $attachment_id );
	...
	public function test_it_should_set_quality_with_image_conversion(): void {
		...
		$editor = wp_get_image_editor( TESTS_PLUGIN_DIR . '/data/images/dice.png', array( 'mime_type' => 'image/png' ) );
		...
		$editor = wp_get_image_editor( TESTS_PLUGIN_DIR . '/data/images/leaves.jpg' );
